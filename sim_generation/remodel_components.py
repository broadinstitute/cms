...
def main():
	if len(sys.argv) != 5:
		print('call program as: python remodel_components.py {model} {regime} {selpop} {irep}')
		sys.exit(0)
	model = sys.argv[1]
	regime = sys.argv[2]
	...
	ihs_commandstring = "/idi/sabeti-scratch/jvitti/selscan/bin/linux/selscan"
	...
	ihs_argstring = " --ihs --tped " + tped_filename + " --out " + ihs_outfileprefix + " --threads 8"
	...
	nsl_commandstring = "/idi/sabeti-scratch/jvitti/selscan/bin/linux/selscan"
	...
	for altpop in altpops:
		...
		xpehh_commandstring = "/idi/sabeti-scratch/jvitti/selscan/bin/linux/selscan"
