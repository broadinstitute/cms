...
int main(int argc, char **argv) {
	...
	if (argc != 8) {
		fprintf(stderr, "Usage: ./combine_cms_scores_poppairs <ihs1filename> <delihh1filename> <xpfilename> <xp reversed? 0T 1F> <fst_deldaffilename> <deldaf reversed? 0T 1F> <outfilename>\n");
		exit(0);
	}
