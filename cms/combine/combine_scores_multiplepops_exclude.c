// for debug; file hard-coded for quick calc of modified CMS_gw
// last updated: 11.7.16   vitti@broadinstitute.org
...
int main(int argc, char **argv) {
	...
	for (isnp = 0; isnp < data.nsnps; isnp++){
		...
		compLikeRatio = delihh_bf * ihs_bf * fst_bf * xpehh_bf; //* deldaf_bf
