// last updated 1.5.16: new top-level program for compositing 		vitti@broadinstitute.org
// gcc -O0 -ggdb3 -lm -Wall -o combine_scores_alt combine_scores_alt.c cms_data.c
...
int main(int argc, char **argv) {
	...
	if (argc <= 3) {
		fprintf(stderr, "Usage: ./combine_scores_alt <savefilename> <cms_run_paramfile> <input_pair_file1> ...\n");
		exit(0);
	}
	nComparisons = argc - 3;
