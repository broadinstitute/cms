...
// --> COMPILE: gcc -o combine_cms_scores -O0 -ggdb3 -lm -Wall combine_cms_scores.c cms_data.c
...
int main(int argc, char **argv) {
	...
	if (argc != 10) {
		fprintf(stderr, "Usage: ./combine_cms_scores <chrom> <selpop> <otherpop> <ihs1filename> <delihh1filename> <xpfilename> <xp reversed? 0T 1F> <fst_deldaffilename> <deldaf reversed? 0T 1F>\n");
		exit(0);
	}
