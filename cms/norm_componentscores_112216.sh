...
MYFILE=/idi/sabeti-scratch/jvitti/cms/cms/norm_componentscores_112216_taskargs.txt
SAMPLE=$(awk "NR==$SGE_TASK_ID" $MYFILE)
python /idi/sabeti-scratch/jvitti/power.py run_norm_neut_repscores $SAMPLE
